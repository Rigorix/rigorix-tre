...
<body ng-controller="Main" ng-class="modalClass" ng-click="doClick($event)">
  ...
  <div class="game-play-container mtl" style="position: relative; padding-bottom: 100%">
    <style><?php echo $core->print_shooter_style(); ?></style>
    <div class="calciatore" ng-controller="Animation.Shooter"></div>
  </div>
